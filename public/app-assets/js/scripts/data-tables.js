...
$(function () {
  ...
  var columDefs = JSON.parse($('#page-length-option').attr('columndefs'));
  var config = {
      "responsive": true,
      "lengthMenu": [
          [10, 25, 50, -1],
      ...
      "language": {
          "url": baseUrl + "/app-assets/vendors/data-tables/js/Portuguese-Brasil.json"
      }
  };
  if(columDefs)
    config.columnDefs = columDefs;
  console.log(config);
  $('#page-length-option').DataTable(config);
